...
export default function SignupPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setLoading(true);
        try {
            // Assuming the backend endpoint is /api/auth/register
            ...
            if (response.data.tokens) {
                ...
                setAuthData(tokens.access_token, tokens.refresh_token, user.id);
        ...
        <Box sx={{ display: 'flex', height: '100vh', overflow: 'hidden', bgcolor: '#111' }}>
            ...
            <Box
                ...
                sx={{
                    ...
                    position: 'relative',
                    zIndex: 10,
                    overflowY: 'auto' // Allow scroll if form is tall
                }}
            >
